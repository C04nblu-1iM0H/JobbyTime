                ...
                <div className="job__card__footer__actions">
                    <button 
                        className={`job__card__footer__actions__edit-button 
                            ${currentRoute === AppRouting.AppliedResults? "job__card__footer__actions__edit-results": null}`}
                        >
                        View/Edit Cover Letter
                        {
                            currentRoute === AppRouting.AppliedResults
                            ?(<img className="job__card__footer__actions__icon" src={cover_result} alt="cover_latter_icon" />)
                            :(<img className="job__card__footer__actions__icon" src={coverLatter} alt="cover_latter_icon" />)
                        }
                    </button>
                    ...
                    {
                        currentRoute === AppRouting.AutoApply 
                        ? <Apply job={job} setIsLoading={setIsLoading}/>
                        : null
                    }
                </div>
            </div>
